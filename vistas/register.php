...
<div class="register-box">
  <div class="register-logo">
    <a href="login.php"><b>Sistema de gestion</b></a>
  </div>
  ...
  <div class="register-box-body">
    ...
    <form action="" method="post" id="frmRegister">
      ...
      <div class="form-group has-feedback">
        <select id="tipo_documento" name="tipo_documento" class="form-control selectpicker">
          <option value="CEDULA">CEDULA</option>
          
        </select>
      </div>
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="Número de documento" id="num_documento" name="num_documento">
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
      ...
      <div class="form-group has-feedback">
       ...
       <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="Telefóno" id="telefono" name="telefono">
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
      ...
      <div class="form-group has-feedback">
        <input type="password" class="form-control" placeholder="Confirmar password" id="confirmar_password" name="confirmar_password">
    ...
    <a href="login.php" class="text-center">Yo la estoy registrado</a>
  </div>
  <!-- /.form-box -->
</div>
<!-- /.register-box -->
...
<script type="text/javascript" src="../public/js/bootbox.all.js"></script>

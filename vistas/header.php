      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="capacitacion.php"><i class="fa fa-circle-o"></i>Capacitación</a></li>
           <li class="active"><a href="formacion.php"><i class="fa fa-circle-o"></i>Formación</a></li>
             <li class="active"><a href="halazgos.php"><i class="fa fa-circle-o"></i>Hallazgos</a></li>
           <li class="active"><a href="inspeccion.php"><i class="fa fa-circle-o"></i>Inspeción</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
